...
![等值收窄的使用](images/02-02-等值收窄的使用.png)
...
![宽松相等的使](/images/02-03-宽松相等的使用.png)
...
![赋值语句收窄](/images/02-04-赋值语句收窄.png)
...
![赋值语句的错误使用](images/02-05-赋值语句的错误使用.png)
...
![TS 的控制流分析](images/02-06-TS%20的控制流分析.png)
...
![可辩别类型应用于switch](images/02-07-可辩别类型应用于switch.png)
